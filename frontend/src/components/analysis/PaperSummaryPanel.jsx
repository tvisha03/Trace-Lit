    ...
    <div className="flex flex-col h-full bg-tl-bg animate-in fade-in duration-500 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-8">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            <div className="flex-1">
              <h1 className="text-lg md:text-xl font-serif text-tl-t1 font-bold leading-tight tracking-tight mb-3">
                {title}
              </h1>
              <div className="flex flex-wrap items-center gap-4">
                {meta && (
                  <p className="font-mono text-[9.5px] text-tl-t4 uppercase tracking-[0.2em] font-bold">
                    {meta}
                  </p>
                )}
          ...
          <div className="relative group">
            ...
            <div className="relative flex flex-col md:flex-row gap-3 bg-tl-bg border border-tl-b1/50 rounded-2xl p-2 focus-within:border-tl-gold/30 transition-all duration-300">
              ...
              <button
                ...
                disabled={!isReady || loading}
                className={`
                  flex items-center justify-center gap-2 px-4 py-1.5 rounded-lg transition-all duration-300 font-sans text-[11px] font-bold uppercase tracking-widest shadow-lg
                  ${!isReady || loading
      ...
      <div className="flex-1 overflow-y-auto scroll-smooth">
        <div className="max-w-4xl mx-auto px-8 py-10">
          ...
          {error && (
            <div className="p-4 bg-tl-low/10 border border-tl-low/30 rounded-xl mb-8 flex items-start gap-3">
              <p className="font-sans text-[13px] text-tl-low leading-relaxed font-medium">{error}</p>
            </div>
          )}
