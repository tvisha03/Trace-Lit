"""
Message — single chat turn within a session.
Stores role, content, which LLM provider answered, and HAVF metadata.
"""
...
class Message(Base):
    ...
    # havf_results schema: [{"sentence_id": "P5_S2", "confidence": 0.91, "level": "high", ...}]
