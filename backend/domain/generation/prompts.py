...
2. EVERY factual claim MUST include a citation in [P#] format (e.g., [P5]).
...
You will receive context paragraphs labeled with [P#] IDs. Reference them in your response."""
...
Respond using ONLY the context above. Cite every claim with [P#] references."""
...
For every comparison point, cite BOTH papers using [P#] references.
...
Cite every point with [P#] references. Use only the provided context."""
...
Cite every observation with [P#] references. State clearly when making inferences."""
