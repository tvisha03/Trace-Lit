...
class ComparisonUpdateRequest(BaseModel):
    """Request body for updating comparison table cells."""
...
class CitationSource(BaseModel):
    """A single citation source linking to a specific sentence."""
...
class SentenceVerification(BaseModel):
    """Verification result for a single generated sentence."""
...
class ChatResponse(BaseModel):
    """Full chat response with verified sentences."""
...
class ContributionSchema(BaseModel):
    """Comparison table row for a single paper."""
...
class ErrorResponse(BaseModel):
    """Standardized error response — never raw stack traces."""
